...
from app.routers import auth, campaigns, characters, dice, dm, quests, ws
...
app = FastAPI(title=settings.app_name, version="0.2.0", lifespan=lifespan, debug=settings.debug)
